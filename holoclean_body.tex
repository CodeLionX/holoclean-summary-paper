...
\section{The \holoclean{} Framework}\label{sec:framework}
  ...
  These matches are stored in a new relation \ddrule{Matched(t,a,v,k)}, where $k$ denotes the dictionary which provided the value.
...
\section{Performance of \holoclean{}}\label{sec:performance}
  ...
  Most frequent error type are duplicates.
