...
\begin{tikzpicture}[
  ...
  \begin{scope}
    ...
    \node[tool, align=center] at (-1.13,-0.05) {Data\\Tamer\cite{data_tamer}};
    \node[tool, align=center] at (-0.87,0.1) {Editing\\Rules\cite{editing_rules}};
    \node[tool, align=center] at (-1,0.5) {Guided\\Data\\Repair\cite{gdr}};
    \node[tool, align=center] at (-1,0.85) {AJAX\\\cite{ajax}};
    
    \node[tool, align=center] at (0,-0.05) {KATARA\\\cite{katara}};
